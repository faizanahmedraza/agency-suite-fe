      ...
      <Card>
                      ...
                      <Col md="6" sm="12">
                        <Row>
                          ...
                          <Col md="6" sm="12" className="d-flex flex-column">
                            ...
                            <small>
                              <Label>Recommended: 390x190 px</Label>
                            </small>
                            <Input
                              type="file"
                    ...
                    <Row>
                      <Col md="6" sm="12">
                        <div className="mb-1">
                          ...
                          <Input
                            type="select"
                            value={serviceDetails.subscription_type}
                        ...
                        <>
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              ...
                              <Input
                                type="number"
                                value={serviceDetails.purchase_limit}
                                onChange={handleInputField}
                                name="purchase_limit"
                                id="nameMulti"
                                placeholder="0"
                        ...
                        <>
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              <Label className="form-label" for="select-basic">
                                Weekly &nbsp;
                                <small>
                                  ( Billed per week. Leave empty to disable )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <InputGroupText>$</InputGroupText>
                                <Input
                                  value={serviceDetails.weekly}
                                  onChange={handleInputField}
                                  name="weekly"
                                  placeholder="0.00"
                                />
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              <Label className="form-label" for="select-basic">
                                Monthly &nbsp;
                                <small>
                                  ( Billed per month. Leave empty to disable )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <InputGroupText>$</InputGroupText>
                                <Input
                                  value={serviceDetails.monthly}
                                  placeholder="0.00"
                                  name="monthly"
                                  onChange={handleInputField}
                                />
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              <Label className="form-label" for="select-basic">
                                Quarterly &nbsp;
                                <small>
                                  ( Billed every three months. Leave empty to
                                  disable )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <InputGroupText>$</InputGroupText>
                                <Input
                                  value={serviceDetails.quarterly}
                                  placeholder="0.00"
                                  name="quarterly"
                                  onChange={handleInputField}
                                />
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              <Label className="form-label" for="select-basic">
                                Biannually &nbsp;
                                <small>
                                  ( Billed every six months. Leave empty to
                                  disable )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <InputGroupText>$</InputGroupText>
                                <Input
                                  value={serviceDetails.biannually}
                                  placeholder="0.00"
                                  name="biannually"
                                  onChange={handleInputField}
                                />
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1">
                              <Label className="form-label" for="select-basic">
                                Annually &nbsp;
                                <small>
                                  ( Billed per year. Leave empty to disable )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <InputGroupText>$</InputGroupText>
                                <Input
                                  value={serviceDetails.annually}
                                  placeholder="0.00"
                                  name="annually"
                                  onChange={handleInputField}
                                />
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1 d-flex flex-column">
                              ...
                              <Label>
                                <small>
                                  ( Leave empty if you allow unlimited
                                  concurrent requests for this subscription. )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <Input
                                  value={serviceDetails.max_concurrent_requests}
                                  placeholder="0"
                          ...
                          <Col md="6" sm="12">
                            <div className="mb-1 d-flex flex-column">
                              ...
                              <Label>
                                <small>
                                  ( Leave empty if you allow unlimited requests
                                  per month for this subscription. )
                                </small>
                              </Label>
                              <InputGroup className="input-group-merge mb-2">
                                <Input
                                  value={serviceDetails.max_requests_per_month}
                                  placeholder="0"
        ...
        >
          ...
          <ModalBody>
            ...
            <div className="mb-2">
              <Label className="form-label" for="placeholder">
                Place Holder:
              </Label>
              <Input
                type="text"

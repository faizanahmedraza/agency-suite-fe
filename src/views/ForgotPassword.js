...
const ForgotPassword = () => {
  ...
  const { forgotPassword: { loading } , portal_settings: { detail: { portal_settings }} } = useSelector(state => state)

  const onSubmitHandler = (e) => {
    e.preventDefault()
    dispatch(ForgotPasswordAction.forgotPassword(agencyInformation))
  }
        ...
        <Row className='auth-inner m-0'>
          ...
          <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
            <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
              ...
              <Form className='auth-forgot-password-form mt-2' onSubmit={onSubmitHandler}>
                <div className='mb-1'>

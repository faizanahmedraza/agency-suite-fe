          ...
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <Form className='auth-login-form mt-2' onSubmit={onSubmitHandler}>
              <div className='mb-1'>
                ...
                <Input type='email' id='login-email' value={agencyInformation.email} name="email" onChange={handleInputChange} placeholder='Enter Your Email' autoFocus />
              </div>
              <div className='mb-1'>
